...
def session_to_dict(session: SessionState) -> dict:
    ...
    return {
        ...
        "api_phone_number": session.api_phone_number,
        "current_plan_name": session.current_plan_name,
        "previous_plan_name": session.previous_plan_name,
        ...
        "plan_anclado": session.plan_anclado,
        "rejection_count": session.rejection_count,
        "stage": session.stage,
        "end_reason": session.end_reason,
        "esperando_criterio_recomendacion": session.esperando_criterio_recomendacion,
...
def dict_to_session(data: dict) -> SessionState:
    ...
    return SessionState(
        ...
        api_phone_number=data.get("api_phone_number"),
        current_plan_name=data.get("current_plan_name", ""),
        previous_plan_name=data.get("previous_plan_name", ""),
        ...
        plan_anclado=data.get("plan_anclado", ""),
        rejection_count=int(data.get("rejection_count", 0)),
        stage=data.get("stage", "PERSUASION"),
        end_reason=data.get("end_reason", ""),
        esperando_criterio_recomendacion=bool(data.get("esperando_criterio_recomendacion", False)),
