...
INTENCIONES = {
    ...
    "facturacion": [
        "en que fecha del mes se realiza el cobro",
        "cual es mi fecha de cobro",
        "en que fecha tengo que pagar",
    ...
    "info_plan_actual": [
        ...
        "cuanto estoy pagando actualmente segun mi plan contratado",
        "cual es mi plan actual",
        "que plan tengo contratado",
        "cuantos datos tiene mi plan actual",
        "cual es el monto de mi renta actual contratada",
    ...
    "comparar_beneficios": [
        ...
        "compara mi plan con el telcel libre 3",
        "compara con el libre 3",
        "compara mi plan con ese plan",
        "compara mi plan actual con ese",
        "compara mi plan con el ultra",
        "compara mi plan con el libre",
        "quiero comparar con ese plan",
        "comparalo con mi plan actual",
    ],
    "planes_mas_baratos": [
    ...
    "planes_libre": [
        ...
        "que planes libre tienen disponibles",
        "mostrame la familia telcel libre",
        "cuales son los planes libre",
        "ver planes libre telcel",
        "tienes planes libres",
        "planes de la familia libre",
